...
import { useGetWeatherByLocationQuery } from "../../slices/weatherApiSlice";

const CurrentWeatherCard = () => {
  const { location } = useSelector(weatherSelector)
  const { isLoading, data: todayWeather = {} } = useGetWeatherByLocationQuery(location);
